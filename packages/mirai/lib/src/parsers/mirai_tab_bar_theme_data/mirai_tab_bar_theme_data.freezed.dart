...
/// @nodoc
mixin _$MiraiTabBarThemeData {
  MiraiBoxDecoration? get indicator => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $MiraiTabBarThemeDataCopyWith<$Res> {
  factory $MiraiTabBarThemeDataCopyWith(MiraiTabBarThemeData value,
          $Res Function(MiraiTabBarThemeData) then) =
      _$MiraiTabBarThemeDataCopyWithImpl<$Res, MiraiTabBarThemeData>;
  @useResult
  $Res call(
...
/// @nodoc
class _$MiraiTabBarThemeDataCopyWithImpl<$Res,
        $Val extends MiraiTabBarThemeData>
    implements $MiraiTabBarThemeDataCopyWith<$Res> {
  _$MiraiTabBarThemeDataCopyWithImpl(this._value, this._then);
  ...
  $MiraiBoxDecorationCopyWith<$Res>? get indicator {
    ...
    return $MiraiBoxDecorationCopyWith<$Res>(_value.indicator!, (value) {
...
abstract class _MiraiTabBarThemeData implements MiraiTabBarThemeData {
  const factory _MiraiTabBarThemeData(
      {final MiraiBoxDecoration? indicator,
      final String? indicatorColor,
      final TabBarIndicatorSize? indicatorSize,
      final String? dividerColor,
