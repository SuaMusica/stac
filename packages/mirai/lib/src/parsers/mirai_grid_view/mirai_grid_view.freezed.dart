...
MiraiGridView _$MiraiGridViewFromJson(Map<String, dynamic> json) {
  return _MiraiGridView.fromJson(json);
}

/// @nodoc
mixin _$MiraiGridView {
...
/// @nodoc
abstract class $MiraiGridViewCopyWith<$Res> {
  factory $MiraiGridViewCopyWith(
          MiraiGridView value, $Res Function(MiraiGridView) then) =
      _$MiraiGridViewCopyWithImpl<$Res, MiraiGridView>;
  @useResult
  $Res call(
...
/// @nodoc
class _$MiraiGridViewCopyWithImpl<$Res, $Val extends MiraiGridView>
    implements $MiraiGridViewCopyWith<$Res> {
  _$MiraiGridViewCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MiraiGridViewImplCopyWith<$Res>
    implements $MiraiGridViewCopyWith<$Res> {
  factory _$$MiraiGridViewImplCopyWith(
          _$MiraiGridViewImpl value, $Res Function(_$MiraiGridViewImpl) then) =
      __$$MiraiGridViewImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Axis scrollDirection,
...
/// @nodoc
class __$$MiraiGridViewImplCopyWithImpl<$Res>
    extends _$MiraiGridViewCopyWithImpl<$Res, _$MiraiGridViewImpl>
    implements _$$MiraiGridViewImplCopyWith<$Res> {
  __$$MiraiGridViewImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$MiraiGridViewImpl(
      scrollDirection: null == scrollDirection
          ? _value.scrollDirection
          : scrollDirection // ignore: cast_nullable_to_non_nullable
              as Axis,
...
/// @nodoc
@JsonSerializable()
class _$MiraiGridViewImpl implements _MiraiGridView {
  const _$MiraiGridViewImpl(
  ...
  factory _$MiraiGridViewImpl.fromJson(Map<String, dynamic> json) =>
      _$$MiraiGridViewImplFromJson(json);
  ...
  _$$MiraiGridViewImplCopyWith<_$MiraiGridViewImpl> get copyWith =>
      __$$MiraiGridViewImplCopyWithImpl<_$MiraiGridViewImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MiraiGridViewImplToJson(
      this,
    );
  }
}

abstract class _MiraiGridView implements MiraiGridView {
  const factory _MiraiGridView(
      {final Axis scrollDirection,
      final bool reverse,
      final bool primary,
      final MiraiScrollPhysics? physics,
      ...
      final ScrollViewKeyboardDismissBehavior keyboardDismissBehavior,
      final String? restorationId,
      final Clip clipBehavior}) = _$MiraiGridViewImpl;

  factory _MiraiGridView.fromJson(Map<String, dynamic> json) =
      _$MiraiGridViewImpl.fromJson;
