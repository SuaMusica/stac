...
/// @nodoc
mixin _$MiraiAlertDialog {
  Map<String, dynamic>? get icon => throw _privateConstructorUsedError;
  MiraiEdgeInsets? get iconPadding => throw _privateConstructorUsedError;
  String? get iconColor => throw _privateConstructorUsedError;
  Map<String, dynamic>? get title => throw _privateConstructorUsedError;
  MiraiEdgeInsets? get titlePadding => throw _privateConstructorUsedError;
  ...
  MiraiTextStyle? get contentTextStyle => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $MiraiAlertDialogCopyWith<$Res> {
  factory $MiraiAlertDialogCopyWith(
          MiraiAlertDialog value, $Res Function(MiraiAlertDialog) then) =
      _$MiraiAlertDialogCopyWithImpl<$Res, MiraiAlertDialog>;
  @useResult
  $Res call(
...
/// @nodoc
class _$MiraiAlertDialogCopyWithImpl<$Res, $Val extends MiraiAlertDialog>
    implements $MiraiAlertDialogCopyWith<$Res> {
  _$MiraiAlertDialogCopyWithImpl(this._value, this._then);
  ...
  $MiraiEdgeInsetsCopyWith<$Res>? get iconPadding {
    ...
    return $MiraiEdgeInsetsCopyWith<$Res>(_value.iconPadding!, (value) {
  ...
  $MiraiEdgeInsetsCopyWith<$Res>? get titlePadding {
    ...
    return $MiraiEdgeInsetsCopyWith<$Res>(_value.titlePadding!, (value) {
  ...
  $MiraiTextStyleCopyWith<$Res>? get titleTextStyle {
    ...
    return $MiraiTextStyleCopyWith<$Res>(_value.titleTextStyle!, (value) {
  ...
  $MiraiTextStyleCopyWith<$Res>? get contentTextStyle {
    ...
    return $MiraiTextStyleCopyWith<$Res>(_value.contentTextStyle!, (value) {
  ...
  $MiraiEdgeInsetsCopyWith<$Res>? get actionsPadding {
    ...
    return $MiraiEdgeInsetsCopyWith<$Res>(_value.actionsPadding!, (value) {
  ...
  $MiraiEdgeInsetsCopyWith<$Res>? get buttonPadding {
    ...
    return $MiraiEdgeInsetsCopyWith<$Res>(_value.buttonPadding!, (value) {
  ...
  @pragma('vm:prefer-inline')
  $MiraiEdgeInsetsCopyWith<$Res> get insetPadding {
    return $MiraiEdgeInsetsCopyWith<$Res>(_value.insetPadding, (value) {
...
class _$MiraiAlertDialogImpl implements _MiraiAlertDialog {
  ...
  @override
  final MiraiEdgeInsets? iconPadding;
  @override
  ...
  @override
  final MiraiEdgeInsets? titlePadding;
  @override
...
abstract class _MiraiAlertDialog implements MiraiAlertDialog {
  const factory _MiraiAlertDialog(
      {final Map<String, dynamic>? icon,
      final MiraiEdgeInsets? iconPadding,
      final String? iconColor,
      final Map<String, dynamic>? title,
  ...
  Map<String, dynamic>? get icon;
  @override
  MiraiEdgeInsets? get iconPadding;
  @override
  String? get iconColor;
  @override
  Map<String, dynamic>? get title;
  @override
  MiraiEdgeInsets? get titlePadding;
  @override
  ...
  @override
  MiraiTextStyle? get contentTextStyle;
  @override
  List<Map<String, dynamic>>? get actions;
  @override
  ...
  double? get actionsOverflowButtonSpacing;
  @override
  MiraiEdgeInsets? get buttonPadding;
  @override
