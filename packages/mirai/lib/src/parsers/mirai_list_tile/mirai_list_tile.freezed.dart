...
MiraiListTile _$MiraiListTileFromJson(Map<String, dynamic> json) {
  return _MiraiListTile.fromJson(json);
}
...
/// @nodoc
abstract class $MiraiListTileCopyWith<$Res> {
  factory $MiraiListTileCopyWith(
          MiraiListTile value, $Res Function(MiraiListTile) then) =
...
/// @nodoc
class _$MiraiListTileCopyWithImpl<$Res, $Val extends MiraiListTile>
    implements $MiraiListTileCopyWith<$Res> {
  _$MiraiListTileCopyWithImpl(this._value, this._then);
