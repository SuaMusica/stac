...
_$MiraiSnackBarImpl _$$MiraiSnackBarImplFromJson(Map<String, dynamic> json) =>
    _$MiraiSnackBarImpl(
      ...
      duration: json['duration'] == null
          ? const MiraiDuration(milliseconds: 4000)
          : MiraiDuration.fromJson(json['duration'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$MiraiSnackBarImplToJson(_$MiraiSnackBarImpl instance) =>
    <String, dynamic>{
