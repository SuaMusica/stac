...
StacAppBar _$StacAppBarFromJson(Map<String, dynamic> json) => StacAppBar(
  leading: const StacWidgetJsonConverter().fromJson(
    json['leading'] as Map<String, dynamic>?,
  ),
  automaticallyImplyLeading: json['automaticallyImplyLeading'] as bool?,
  title: const StacWidgetJsonConverter().fromJson(
    json['title'] as Map<String, dynamic>?,
  ),
  actions: const StacWidgetListJsonConverter().fromJson(
    json['actions'] as List<Map<String, dynamic>>?,
  ),
  flexibleSpace: const StacWidgetJsonConverter().fromJson(
    json['flexibleSpace'] as Map<String, dynamic>?,
  ),
  bottom: const StacWidgetJsonConverter().fromJson(
...
Map<String, dynamic> _$StacAppBarToJson(StacAppBar instance) =>
    <String, dynamic>{
      'leading': const StacWidgetJsonConverter().toJson(instance.leading),
      'automaticallyImplyLeading': instance.automaticallyImplyLeading,
      'title': const StacWidgetJsonConverter().toJson(instance.title),
      'actions': const StacWidgetListJsonConverter().toJson(instance.actions),
      'flexibleSpace': const StacWidgetJsonConverter().toJson(
        instance.flexibleSpace,
      ),
      'bottom': const StacWidgetJsonConverter().toJson(instance.bottom),
