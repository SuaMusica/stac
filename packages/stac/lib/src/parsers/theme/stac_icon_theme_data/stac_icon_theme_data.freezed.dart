...
/// Adds pattern-matching-related methods to [StacIconThemeData].
extension StacIconThemeDataPatterns on StacIconThemeData {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacIconThemeData() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _StacIconThemeData() when $default != null:
        return $default(_that.size, _that.fill, _that.weight, _that.grade,
            _that.opticalSize, _that.color, _that.opacity, _that.shadows);
      case _:
        return orElse();
    }
  }
