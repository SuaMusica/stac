...
/// Adds pattern-matching-related methods to [StacScrollbarThemeData].
extension StacScrollbarThemeDataPatterns on StacScrollbarThemeData {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StacScrollbarThemeData value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacScrollbarThemeData() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _StacScrollbarThemeData() when $default != null:
        return $default(
            _that.thumbVisibility,
            _that.thickness,
            _that.trackVisibility,
            _that.radius,
            _that.thumbColor,
            _that.trackColor,
            _that.trackBorderColor,
            _that.crossAxisMargin,
            _that.mainAxisMargin,
            _that.minThumbLength,
            _that.interactive);
      case _:
        return orElse();
    }
