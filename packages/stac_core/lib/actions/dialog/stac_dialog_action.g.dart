...
Map<String, dynamic> _$StacDialogActionToJson(
  StacDialogAction instance,
) => <String, dynamic>{
  ...
  'traversalEdgeBehavior':
      _$StacDialogTraversalEdgeBehaviorEnumMap[instance.traversalEdgeBehavior],
  'actionType': instance.actionType,
};

const _$StacDialogTraversalEdgeBehaviorEnumMap = {
  StacDialogTraversalEdgeBehavior.closedLoop: 'closedLoop',
  StacDialogTraversalEdgeBehavior.leaveFlutterView: 'leaveFlutterView',
  StacDialogTraversalEdgeBehavior.parentScope: 'parentScope',
  StacDialogTraversalEdgeBehavior.stop: 'stop',
};
